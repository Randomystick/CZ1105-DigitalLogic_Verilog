...
HD_PWD='C:/.PROGRAMMING/Verilog/Lab3/Lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vsevenseg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vsevenseg.tcl
