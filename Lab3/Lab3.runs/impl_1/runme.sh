...
HD_PWD='C:/.PROGRAMMING/Verilog/Lab3/Lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vsevenseg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vsevenseg.tcl -notrace
