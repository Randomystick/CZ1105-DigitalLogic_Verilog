# Clock signal. Lines 2 to 4 enable the 100MHz system clock and connect it to clk.
...
# Buttons // active high - press to produce 1. Lines 70-71 connect the reset (rst) to the center pushbutton
# // use btnC as RESET
