...
HD_PWD='C:/.PROGRAMMING/Verilog/CZ1105-Verilog/Lab4/Lab4_part2/Lab4_part2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log segtoggle.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source segtoggle.tcl -notrace
